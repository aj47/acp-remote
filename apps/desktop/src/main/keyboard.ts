      ...
      if (stderrBuffer.includes("PermissionDenied") || stderrBuffer.includes("Permission denied")) {
        ...
        if (Notification.isSupported()) {
          const notification = new Notification({
            title: "ACP Remote: Hotkeys Not Working",
          ...
          notification.on("click", () => {
            dialog.showMessageBox({
              ...
              detail: "Run this command in a terminal:\n\nsudo usermod -aG input $USER\n\nThen log out and log back in for the change to take effect.\n\nThis is required because ACP Remote needs to read keyboard events from /dev/input/ devices.",
              buttons: ["OK"],
            })
          })
          notification.show()
        ...
        console.error(
          "[ACP Remote] Global hotkeys failed: Permission denied.\n" +
