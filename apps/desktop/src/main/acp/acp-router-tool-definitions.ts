...
export const acpRouterToolDefinitions = [
  {
    name: 'acpremote-builtin:list_available_agents',
    description:
  ...
  {
    name: 'acpremote-builtin:delegate_to_agent',
    description:
  ...
  {
    name: 'acpremote-builtin:check_agent_status',
  ...
  {
    name: 'acpremote-builtin:spawn_agent',
    description:
  ...
  {
    name: 'acpremote-builtin:stop_agent',
  ...
  {
    name: 'acpremote-builtin:cancel_agent_run',
  ...
  {
    name: 'acpremote-builtin:send_to_agent',
    description:
  ...
  {
    name: 'acpremote-builtin:get_task_status',
  ...
  {
    name: 'acpremote-builtin:cancel_task',
...
export const toolNameAliases: Record<string, string> = {
  'acpremote-builtin:send_to_agent': 'acpremote-builtin:delegate_to_agent',
  'acpremote-builtin:get_task_status': 'acpremote-builtin:check_agent_status',
  'acpremote-builtin:cancel_task': 'acpremote-builtin:cancel_agent_run',
};
